...
* Their primary result is that by poisoning just 0.001\% of the input data or applying a patch to 0.005\% of the data, their malicious attacks succeed.
...
![](https://github.com/jpaynter/iclr-blog-track.github.io/blob/gh-pages/_includes/CLIP_fig1.PNG)
