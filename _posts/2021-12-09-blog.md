...
*A stylized version of the poisoning attack on a contrastive learner. A certain number of malicious examples are introduced - here images of the lovely poodle-mix along with captions that include the adversarially intended label: plane. (figure by author using cropped parts of OpenAI's CLIP figure 1)*
