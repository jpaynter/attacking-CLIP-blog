...
*The goal of a contrastive learner is lower-dimensional representations of text (green) and images (purple) such that input pairs have maximal similarity. (cropped figure from Open AI's CLIP)*
